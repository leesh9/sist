...
<link rel="stylesheet" href="/ex4/resources/css/summernote-lite.css" />
	...
	encType="multipart/form-data"><%-- 폼에 파일을 첨부하게 될 때
		...
		<table summary="게시판 글쓰기">
			...
			<tbody>
				<tr>
					<th>제목:</th>
					<td><input type="text" name="subject" data-str="제목" size="45" value="${vo.subject}"/></td>
				</tr>
				<tr>
					<th>이름:</th>
					<td><input type="text" name="writer" data-str="이름" size="12" value="${vo.writer}"/></td>
				</tr>
				<tr>
					<th>내용:</th>
...
-->
				<tr>
					<td colspan="2">
						...
						<input type="button" value="목록" onclick="javascript:location.href='Controller?type=list&cPage=${param.cPage}&bname=${param.bname}'"/>
					</td>
				</tr>
			</tbody>
		</table>
...
<script src="/ex4/resources/js/summernote-lite.js"></script>
<script src="/ex4/resources/js/lang/summernote-ko-KR.js"></script>
<script type="text/javascript">
	$(function() {
		$("#content").summernote({
			lang: "ko-KR",
