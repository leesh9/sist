...
onclick="javascript:location.href='edit?b_idx=${vo.b_idx}&bname=${param.bname }&cPage=${param.cPage }'"/> --%>
                  <input type="button" value="수정"
                     onclick="edit()"/>
   ...
   <script>
      ...
      function listBbs(){
      //   location.href="Controller?type=list&cPage=${param.cPage}&bname=${param.bname }"
